    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
				...
				<a href='http://csis.svsu.edu/~bawillso/Bwill/Screenflow.png' target='_blank'>Screenflow</a><br />
				<a href='http://csis.svsu.edu/~bawillso/Bwill/UML.png' target='_blank'>UML</a><br />
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
